...
Шорт-код [schedule]...[/schedule] преобразует расписание богослужений в простой текстовой форме, заключенное между тегами шорт-кода, в таблицу, добавляя описания дней и наименования седмиц.
