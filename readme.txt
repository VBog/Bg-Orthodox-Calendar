...
Если в параметре day указать “'post'”, то в качестве даты, буде принята дата публикации поста/страницы. 
В обоих случаях значения параметров month и year будут проигнорированы.
...
* Если в параметре шорт-кодов day указать “'post'”, то в качестве даты, буде принята дата публикации поста/страницы. 
